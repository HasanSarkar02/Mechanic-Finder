...
<body>
            ...
            <ul>
                ...
                @else
                    ...
                    <li class="profile-menu">
                        <div class="profile">
                            <img src="{{ Auth::user()->profile_img ? asset('storage/' . Auth::user()->profile_img) : asset('images/default-profile.jpg') }}" 
                                 alt="Profile Picture">
                        </div>
    ...
    <section class="service-categories">
        <div class="category">
            ...
            <p><a href="{{ route('mechanics.index') }}" class="repair-btn">Car Repair</a></p>
        </div>
        <div class="category">
